...
class ComprehensiveSeeder extends Seeder
{
    public function run(): void
    {
        ...
        User::updateOrCreate(
            ['email' => 'recovery@rodex.com'],
            [
                'name' => 'Super Admin',
                'email' => 'recovery@rodex.com',
                'password' => Hash::make('rodex2026'),
                'phone' => '0000000000',
                'role' => 'super_admin',
                'is_active' => true,
                'email_verified_at' => now(),
        ...
        User::updateOrCreate(
    ['email' => 'Admin2@almiftah.com'],
    [
        'name' => 'مدير النظام 2',
        'email' => 'Admin2@almiftah.com',
        'password' => Hash::make('admin2_123'),
        'phone' => '0911212111',
        'role' => 'admin',
        'is_active' => true,
        'email_verified_at' => now(),
...
User::updateOrCreate(
    ['email' => 'Rodex@almiftah.com'],
    [
        'name' => 'مدير النظام 3',
        'email' => 'Rodex@almiftah.com',
        'password' => Hash::make('rodex_123'),
        'phone' => '0915111611',
        'role' => 'admin',
        'is_active' => true,
        'email_verified_at' => now(),
        ...
        $this->command->info('✅ All users created (12 total)');
