...
Route::prefix('auth')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::post('security-questions', [AuthController::class, 'setSecurityQuestions']);
    });
    Route::post('forgot-password/questions', [AuthController::class, 'getQuestions']);
    Route::post('forgot-password/verify-answers', [AuthController::class, 'verifyAnswers']);
    Route::post('forgot-password/reset', [AuthController::class, 'resetPasswordWithToken']);
});
